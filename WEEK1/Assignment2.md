...
Change the learning rate, since the dataset is small I wont expect you to be using batches, but still you can try and observe its effect.
...
On July 17, 1586, Mary wrote a long logistical response to Babington's assassination proposal. The text that proved her treason was encrypted using caeser cipher : 
...
(Assume the cipher works on the letters and symbols- ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', ' ', '.', ',', ';', ':', '/', '@'], so no other letter has been used and the cipher rotates the elements of the array as in the case of general caeser cipher.)
